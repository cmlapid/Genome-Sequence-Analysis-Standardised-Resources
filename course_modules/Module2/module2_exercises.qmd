...
Now use the ‘*-I*’ option to specify the input BAM file and the ‘*-I*’ option to specify the output file (e.g. *library1.markdup.bam*). You will also need to specify the duplication metrics output file using ‘*-M*’’ (e.g. *library1.markdup.metrics.txt*).
